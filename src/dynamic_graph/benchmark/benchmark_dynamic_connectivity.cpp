...
int main() {
  ...
  // Initializes graph of `kNumVertices` vertices. For `kIterations`,
  //   - Picks `kOperationsPerIteration` edges and adds all edges that aren't
  //   already in the graph.
  //   - Performs `kOperationsPerIterations / 2` connectvity queries.
  //   - Deletes a `kProportionOfEdgesToDelete` proportion of the edges.
  //   - Performs `kOperationsPerIterations / 2` connectvity queries.
